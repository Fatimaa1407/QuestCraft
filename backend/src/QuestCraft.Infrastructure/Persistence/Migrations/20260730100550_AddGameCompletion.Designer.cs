...
namespace QuestCraft.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730100550_AddGameCompletion")]
    partial class AddGameCompletion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuestCraft.Domain.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<int?>("EquippedBannerId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("GameCompletedAt")
                        .HasColumnType("datetime2");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<DateOnly?>("LastLoginRewardClaimedAt")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("QuestCraft.Domain.Entities.UserProfile", b =>
                {
                    b.HasOne("QuestCraft.Domain.Entities.MarketplaceItem", "EquippedAvatar")
                        .WithMany()
                        .HasForeignKey("EquippedAvatarId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("QuestCraft.Domain.Entities.MarketplaceItem", "EquippedBadge")
                        .WithMany()
                        .HasForeignKey("EquippedBadgeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("QuestCraft.Domain.Entities.MarketplaceItem", "EquippedBanner")
                        .WithMany()
